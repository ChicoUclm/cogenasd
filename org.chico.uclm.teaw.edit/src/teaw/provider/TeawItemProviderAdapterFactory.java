...
public class TeawItemProviderAdapterFactory extends TeawAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link teaw.ReaminingObject} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ReaminingObjectItemProvider reaminingObjectItemProvider;

	/**
	 * This creates an adapter for a {@link teaw.ReaminingObject}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createReaminingObjectAdapter() {
		if (reaminingObjectItemProvider == null) {
			reaminingObjectItemProvider = new ReaminingObjectItemProvider(this);
		}

		return reaminingObjectItemProvider;
	}
	...
	public void dispose() {
		...
		if (reaminingObjectItemProvider != null) reaminingObjectItemProvider.dispose();
