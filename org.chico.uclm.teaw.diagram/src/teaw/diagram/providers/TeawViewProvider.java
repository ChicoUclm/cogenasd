 ...
 * @generated
 */
public class TeawViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return TEAWDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& TeawVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = TeawVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = TeawVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!TeawElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
				...
				if (!TEAWDiagramEditPart.MODEL_ID.equals(TeawVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return EmotionsEditPart.VISUAL_ID == visualID || PlanningEditPart.VISUAL_ID == visualID
				...
				|| SoothingObjectEditPart.VISUAL_ID == visualID || ReaminingObjectEditPart.VISUAL_ID == visualID
				|| CommunicationBookEditPart.VISUAL_ID == visualID;
	}
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = TeawVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != TeawVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(TEAWDiagramEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = TeawVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = TeawVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EmotionsEditPart.VISUAL_ID:
			return createEmotions_2001(domainElement, containerView, index, persisted, preferencesHint);
		case PlanningEditPart.VISUAL_ID:
			return createPlanning_2002(domainElement, containerView, index, persisted, preferencesHint);
		case EmotionChoiceEditPart.VISUAL_ID:
		...
		case ActionEditPart.VISUAL_ID:
			return createAction_3004(domainElement, containerView, index, persisted, preferencesHint);
		case PlaceEditPart.VISUAL_ID:
			return createPlace_3005(domainElement, containerView, index, persisted, preferencesHint);
		case WaitTimeEditPart.VISUAL_ID:
			return createWaitTime_3006(domainElement, containerView, index, persisted, preferencesHint);
		case PrizeEditPart.VISUAL_ID:
			return createPrize_3007(domainElement, containerView, index, persisted, preferencesHint);
		case SocialStoryEditPart.VISUAL_ID:
		...
		case ReaminingObjectEditPart.VISUAL_ID:
			return createReaminingObject_3013(domainElement, containerView, index, persisted, preferencesHint);
		case CommunicationBookEditPart.VISUAL_ID:
	...
	*/
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (TeawVisualIDRegistry.getVisualID(elementTypeHint)) {
		...
		case RedLinkEditPart.VISUAL_ID:
			return createRedLink_4002(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		case GreenLinkEditPart.VISUAL_ID:
			return createGreenLink_4003(getSemanticElement(semanticAdapter), containerView, index, persisted,
					preferencesHint);
		}
	...
	* @generated
	*/
	public Node createEmotions_2001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(EmotionsEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Node createPlanning_2002(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.getStyles().add(NotationFactory.eINSTANCE.createHintedDiagramLinkStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(PlanningEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	* @generated
	*/
	public Node createEmotionChoice_3001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(EmotionChoiceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createEmotion_3002(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	...
	* @generated
	*/
	public Node createPerson_3003(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(PersonEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createAction_3004(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(ActionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createPlace_3005(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(PlaceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createWaitTime_3006(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(WaitTimeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createPrize_3007(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(PrizeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createSocialStory_3008(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(SocialStoryEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Node createSoothingObject_3009(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(SoothingObjectEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	* @generated
	*/
	public Node createReaminingObject_3013(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(ReaminingObjectEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Node createCommunicationBook_3010(EObject domainElement, View containerView, int index, boolean persisted,
		...
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TeawVisualIDRegistry.getType(CommunicationBookEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
	...
	*/
	public Edge createNormalLink_4001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		edge.setType(TeawVisualIDRegistry.getType(NormalLinkEditPart.VISUAL_ID));
	...
	* @generated
	*/
	public Edge createRedLink_4002(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TeawVisualIDRegistry.getType(RedLinkEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
	...
	* @generated
	*/
	public Edge createGreenLink_4003(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(TeawVisualIDRegistry.getType(GreenLinkEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint.getPreferenceStore();
		FontStyle edgeFontStyle = (FontStyle) edge.getStyle(NotationPackage.Literals.FONT_STYLE);
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!TEAWDiagramEditPart.MODEL_ID.equals(TeawVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", TEAWDiagramEditPart.MODEL_ID); //$NON-NLS-1$
